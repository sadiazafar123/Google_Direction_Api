...
object RetrofitClient {
    fun getInstance():ApiInterface{
        ...
        val retrofit: Retrofit =Retrofit.Builder().baseUrl("https://maps.googleapis.com/maps/").addConverterFactory(
            GsonConverterFactory.create(gson)).client(mOkHttpClient.build()).build()
